...
//import Adjacency_List.Adjacency_List; 
//import Adjacency_List.Graph_Node;
...
//	}
	...
	private void algo_bellman_ford(List<List<Node>> adj_list, int src_vertex) {
	...
	public static void main(String[] args) {
		...
		adj_list.get(0).add(new Node(5, -4));
		adj_list.get(2).add(new Node(1, 1));
		adj_list.get(2).add(new Node(3, -3));
		// call Dijkstra's algo method
		Adjacency_List dpq = new Adjacency_List(V);
		dpq.algo_bellman_ford(adj_list, source);
